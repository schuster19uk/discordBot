...
module.exports = {
    ...
    async execute(message) {
        ...
        try {
            ...
            if (rows.length === 0) {
                return message.reply("📋 You don't have any active upcoming bookings at the moment.");
            }
            ...
            message.reply("❌ Database error while fetching your bookings.");
        } finally {
